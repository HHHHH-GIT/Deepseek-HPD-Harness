...
const UI_PLUGIN_DIRS = [
  ...
  'ui-settings', 'ui-settings-general', 'ui-settings-models', 'ui-settings-model-routing', 'ui-conversation',
  'ui-user-questions', 'ui-trajectory', '../session-query/session-log-export',
]
