  ...
  test: {
    ...
    coverage: {
      ...
      exclude: [
        ...
        'packages/client/ui-settings-model-routing/src/index.ts',
        'packages/client/ui-settings-model-routing/src/client/store.ts',
        'packages/client/ui-settings-model-routing/src/client/index.ts',
        'packages/client/ui-settings-model-routing/src/client/ModelRoutingSection.tsx',
