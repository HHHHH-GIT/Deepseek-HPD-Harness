...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/client/ui-h-model-routing': { kind: 'none', reason: 'Browser-side read-only H-plan projection; the host h-model-routing plugin owns every model-visible effect.' },
  ...
  'packages/client/ui-settings-model-routing': { kind: 'none', reason: 'Browser-side settings surface; the h-model-routing host plugin it configures owns every model-visible effect.' },
